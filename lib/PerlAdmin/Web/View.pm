...
use PerlAdmin::Web::ViewFunctions;

# setup view class
sub make_instance {
    my ($class, $context) = @_;
    Carp::croak("Usage: PerlAdmin::View->make_instance(\$context_class)") if @_!=2;
